...
pub(crate) fn extract_imports(content: &str, file_path: &str, root_path: &Path) -> Vec<ImportInfo> {
...
pub(crate) fn parse_typescript_file(file_path: &str, root_path: &Path) -> Result<FileParseResult> {
